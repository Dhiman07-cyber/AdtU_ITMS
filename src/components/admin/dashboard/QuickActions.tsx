...
export default function QuickActions({ role = 'admin' }: { role?: 'admin' | 'moderator' }) {
  ...
  return (
    <Card className="relative overflow-hidden bg-[#0a0b14] border-white/5 shadow-2xl mb-8 p-6 transition-colors duration-300 hover:bg-[#0f101f]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            <h3 className="text-lg md:text-xl font-bold text-white leading-tight">Operational Shortcuts</h3>
            <p className="text-slate-400 text-xs font-medium">Rapid execution matrix for mission-critical tasks</p>
          </div>
        </div>
