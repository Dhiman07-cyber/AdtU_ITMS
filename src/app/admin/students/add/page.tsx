  ...
  return (
    <div className="itms-admin-form-container space-y-6">
      ...
      <div className="itms-page-header-container">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-foreground leading-tight pb-1">Add Student</h1>
            <p className="text-muted-foreground mt-1 text-xs sm:text-sm text-left">Register a new student in the system</p>
          </div>
          <Link
            href="/admin/students"
